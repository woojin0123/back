...
public class CharacterConvertStreamExample {
	...
	public static void write(String str) throws Exception {
		...
		OutputStream os = new FileOutputStream("C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/test.txt");
	...
	public static String read() throws Exception {
		InputStream is = new FileInputStream("C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/test.txt");
