...
public class 파일복사 {
	public static void main(String[] args) throws Exception {
		// 이미지는 28KB
		String originalFileName = "C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/test.jpg";
		String targetFileName = "C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/test2.jpg";
