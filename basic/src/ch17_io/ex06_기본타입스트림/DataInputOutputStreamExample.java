...
public class DataInputOutputStreamExample {
	public static void main(String[] args) throws Exception {
		//DataOutputStream 생성
		FileOutputStream fos = new FileOutputStream("C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/primitive.db");
		...
		//DataInputStream 생성
		FileInputStream fis = new FileInputStream("C:/Users/두드림/wj/git/back/basic/src/ch17_입출력/temp/primitive.db");
