...
public class CharacterConvertStreamExample {
	...
	public static void write(String str) throws Exception {
		OutputStream os = new FileOutputStream("D:/wi/git/back/basic/src/ch17_입출력/temp/test4.txt");
	...
	public static String read() throws Exception {
		InputStream is = new FileInputStream("D:/wi/git/back/basic/src/ch17_입출력/temp/test4.txt");
